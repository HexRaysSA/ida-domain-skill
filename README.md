...
Claude will automatically load `API_REFERENCE.md` when needed for comprehensive documentation on functions, strings, cross-references, segments, types, decompilation, and more.
